...
/**
 * @dev Vault will track the user debt.
 * Vault should named according to the strat it uses.
 */
contract LunariaVault is ERC20, Ownable, ReentrancyGuard {
    ...
    IERC20 public token;
    // The token that can be borrowed with this vault.
    ...
    // Borrowing interest rate for this vault .
     ...
     * @param _interestRate is the borrow interest APR. eg: 1% = 0.01*10^18 (1e6 for usdc)
     * @param _lTV percent of how much the max borrow to collateral. eg: 80% = 0.8*10^18 (1e6 for usdc)
     */
    constructor (
        IStrategy _strategy,
        string memory _name,
